...
//Unsplash API
const UNSPLASH_API_KEY = 'nxkuOV2FGtMyZbrlRCf80d_lI_Gp12Zp9p_O9hEAkUw';
const count = 30;
const apiUrl = `https://api.unsplash.com/search/photos?client_id=${UNSPLASH_API_KEY}&count=${count}&query=dog`;
